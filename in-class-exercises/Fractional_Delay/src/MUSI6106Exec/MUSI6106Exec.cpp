...
int main(int argc, char* argv[])
{
    ...
    pInstance->init(CCombFilterIf::kCombFIR, fMaxDelayLengthInS, stFileSpec.fSampleRateInHz, stFileSpec.iNumChannels);
    ...
    while (!phAudioFile->isEof())
    {
        ...
        pInstance->process(ppfAudioData, ppfOutputBuffer, iNumFrames);
